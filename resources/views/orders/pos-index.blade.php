            		...
            		<table class="table align-items-center justify-content-center mb-0 pb-5 nowrap stripe" id="orders_table">
            			<thead>
            				<tr>
	                      		...
	                      		<th class="text-uppercase text-secondary text-xxs font-weight-bolder text-center opacity-7 ps-2">Created By</th>
	                      		<th></th>
                    		</tr>
                  		</thead>
	                  	<tbody>
	                  		...
	                  		@if($order['stateMachineState']['technicalName'] == "paid" && $order['transactions'][0]['stateMachineState']['technicalName'] == "paid")
			                    <tr>
	                              	<td>
			                    		<a href="{{ url('/pos-orders/'.$order['id']) }}"><p class="text-sm font-weight-bold mb-0">{{ $order['orderNumber'] }}</p></a>
			                      	</td>
			                      	<td>
			                        	<div class="d-flex">
			                          		<div class="my-auto">
			                        ...
			                        <td class="align-middle text-center">
			                        	@if(isset($order['customFields']['createdBy']))
			                        ...
			                        <td class="align-middle">
					                    ...
					                    <ul class="dropdown-menu px-2 py-3 ms-sm-n4 ms-n5 bg-gradient-light" aria-labelledby="dropdownTable">
					                    	<li><a class="dropdown-item border-radius-md loading" href="{{ url('/pos-orders/'.$order['id']) }}">View Details</a></li>
