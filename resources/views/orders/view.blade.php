	...
	<div class="col-12">
		<div class="card my-4">
            ...
            <div class="card-body px-0 pb-2">
				...
				<div class="row">
					<div class="col-md-6">
						<button class="btn bg-gradient-primary mx-3" @if($status == "Complete" || $status == "Paid" || $status == "Cancel") disabled="" @endif onclick="markAsPaid()">Mark as Paid</button>
                      	<button class="btn bg-gradient-danger mx-3" @if($status == "Complete" || $status == "Paid" || $status == "Cancel") disabled="" @endif onclick="cancelOrder()">Cancel Order</button>
						<button class="btn bg-gradient-success" @if($status == "Complete" || $status == "Open" || $status == "Cancel") disabled="" @endif onclick="markAsDone()">Mark as Done</button>
					</div>
				</div>
			</div>
		</div>
