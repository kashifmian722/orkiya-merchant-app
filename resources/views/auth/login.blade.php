              ...
              <form role="form" class="text-start" method="POST" action="{{ url('login') }}">
                ...
                <div class="form-check form-check-info text-start ps-0">
                  <label class="form-check-label" for="flexCheckDefault">
                     <a href="{{ url('/forgot-password') }}" class="text-dark font-weight-bolder">Forgot Password?</a>
                  </label>
                </div>
                <div class="text-center">
                  <button type="submit" class="btn bg-gradient-dark loading w-100 my-4 mb-2">Sign in</button>
                </div>
