      ...
      <div class="row gx-lg-5 align-items-center mb-5">
        ...
        <div class="col-lg-6 mb-5 mb-lg-0 position-relative">
          ...
          <div class="card bg-glass">
            ...
            <div class="card-body">
              <form role="form" class="text-start" method="POST" action="{{ url('forgot-password') }}">
                  @csrf
                <p>Reset password link will be sent to the email.</p>
                ...
                <div class="text-center">
                  <button type="submit" class="btn bg-gradient-dark loading w-100 my-4 mb-2">Submit</button>
                </div>
